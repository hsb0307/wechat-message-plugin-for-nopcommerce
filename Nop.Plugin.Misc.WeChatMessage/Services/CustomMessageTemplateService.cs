...
{
    public partial class CustomMessageTemplateService
    {
        #region Fields
        ...
        protected readonly IRepository<CustomMessageTemplate> _messageTemplateRepository;
        ...
        public CustomMessageTemplateService(
            IStaticCacheManager staticCacheManager,
            ILanguageService languageService,
            ILocalizationService localizationService,
            ILocalizedEntityService localizedEntityService,
            IRepository<CustomMessageTemplate> messageTemplateRepository,
        ...
        public virtual async Task DeleteMessageTemplateAsync(CustomMessageTemplate messageTemplate)
        {
        ...
        /// <param name="messageTemplate">Message template</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertMessageTemplateAsync(CustomMessageTemplate messageTemplate)
        {
        ...
        /// <param name="messageTemplate">Message template</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task UpdateMessageTemplateAsync(CustomMessageTemplate messageTemplate)
        {
        ...
        /// </returns>
        public virtual async Task<CustomMessageTemplate> GetMessageTemplateByIdAsync(int messageTemplateId)
        {
        ...
        /// </returns>
        public virtual async Task<IList<CustomMessageTemplate>> GetMessageTemplatesByNameAsync(string messageTemplateName, int? storeId = null)
        {
            if (string.IsNullOrWhiteSpace(messageTemplateName))
                throw new ArgumentException(nameof(messageTemplateName));

            var key = _staticCacheManager.PrepareKeyForDefaultCache(WeChatMessageDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId);
        ...
        /// </returns>
        public virtual async Task<IList<CustomMessageTemplate>> GetAllMessageTemplatesAsync(int storeId, string keywords = null, bool? isActive = null)
        {
            ...
            }, cache => cache.PrepareKeyForDefaultCache(WeChatMessageDefaults.MessageTemplatesAllCacheKey, storeId, isActive));
        ...
        /// </returns>
        public virtual async Task<CustomMessageTemplate> CopyMessageTemplateAsync(CustomMessageTemplate messageTemplate)
        {
            ArgumentNullException.ThrowIfNull(messageTemplate);

            var mtCopy = new CustomMessageTemplate
            {
                SystemName = messageTemplate.SystemName,
